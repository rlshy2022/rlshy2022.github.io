...
(function() {
    ...
    function snow() {
        ...
        for (var i = 0; i < flakeCount; i++) {
            ...
            ctx.beginPath();
            // 画樱花瓣
            var gradient = ctx.createRadialGradient(flake.x, flake.y, 0, flake.x, flake.y, flake.size);
            gradient.addColorStop(0, "rgba(255, 158, 172," + flake.opacity + ")"); // 粉色核心
